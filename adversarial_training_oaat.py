...
df = pd.read_csv("C:/Users/lkang/Documents/New UAP/ISIC2019_train.csv")
...
for epoch in test_epoch:
    ...
    generate_classification_report(np.argmax(y_test, axis=1), x_test_pred, "classfication_report_clean.txt")
    ...
    generate_classification_report(np.argmax(y_test, axis=1), x_test_attack_pred_eps8s2, "classfication_report_eps8.txt")
...
# generate_classification_report(np.argmax(y_test, axis=1), x_test_attack_pred_eps16s4, "classfication_report_eps16.txt")
