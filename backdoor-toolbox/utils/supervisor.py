...
def get_transforms(args):
    if args.dataset == 'gtsrb':
        ...
        data_transform_aug = data_transform = trigger_transform = transforms.Compose([
            transforms.ToTensor(),  # Convert PIL images to tensors
        ])
        
        normalizer = denormalizer = None
...
def get_poison_transform(poison_type, dataset_name, target_class, source_class=1, cover_classes=[5, 7],
    ...
    if dataset_name in ['gtsrb', 'cifar10', 'cifar100']:
        ...
        img_size = 224
    elif dataset_name == 'OCT' or dataset_name == 'CXRAY' or dataset_name == 'ISIC2019':
        img_size = 256
    else:
