...
from dataloader import ISICDataset,ISIC2018Dataset, get_transform
...
datapath = 'C:/Users/lkang/Documents/isic2018/dataset'
testfile = 'C:/Users/lkang/Documents/df_test.csv'
...
adversarialFile = 'C:/Users/lkang/Documents/df_train.csv'
# adversarialFile = 'C:/Users/lkang/Documents/Master_Code_backup/New UAP/ISIC2019_Adversarial_02.csv'

model_path = 'C:\\Users\\lkang\\Documents\\isic2018\\model\\efficientnetb3_model.pth'

# Load the previously trained model
# num_classes = 2
# num_classes = 4
num_classes = 7
# checkpoint = torch.load('C:/Users/lkang/Documents/Acc75_Epoch50_BS16_3class/ISIC2019_morph.pth.tar',map_location ='cpu')
...
# checkpoint = torch.load('C:/Users/lkang/Documents/ISIC_Model/Acc75_Epoch60_BS32_Clean_8class/ISIC2019_morph.pth.tar',map_location ='cpu')
...
####### ISIC 2018 ###############
df_train=pd.read_csv('C:/Users/lkang/Documents/df_train.csv')
df_train=df_train.drop(columns='Unnamed: 0')
df_test=pd.read_csv('C:/Users/lkang/Documents/df_test.csv')
df_test=df_test.drop(columns='Unnamed: 0')

eval_dataset = ISIC2018Dataset(df_test, transform=val_transform)
eval_loader = DataLoader(eval_dataset, batch_size=8, shuffle=True)
eval_dataset_length = len(eval_dataset)
print(f"Number of images in the evaluation dataset: {eval_dataset_length}")


adv_training_dataset = ISIC2018Dataset(df_train, transform=train_transform)
adv_training_loader = DataLoader(adv_training_dataset, batch_size=8, shuffle=True)
adv_training_length = len(adv_training_dataset)
print(f"Number of images in the adv training dataset: {adv_training_length}")
...
model.eval()
model.load_state_dict(torch.load("C:\\Users\\lkang\\Documents\\End_to_end_decoupled_training_for_skin_lesion_classification-master\\checkpoint\\isic2018_efficientb3_DHML1_W_None_F_32_D_10000000\\best_model_run9.pth"))
# model.eval()
...
# pgd = ProjectedGradientDescent(classifier, eps=8 / 255, eps_step=2 / 255, num_random_init=1)
# 
...
trainer.fit_generator(art_datagen,nb_epochs = 2)
# trainer.fit(
#     x=adversarial_x, 
#     y=adversarial_y,
#     nb_epochs=10,
...
#             results_filename = resultFolder+f'evaluation_results_{image_count}_att{current_attack_eps}_eps{current_eps}.txt'
...
#             classificationReportFileName = resultFolder+f'classification_report_{image_count}_att{current_attack_eps}_eps{current_eps}.txt'
#             generate_classification_report(true_labels,pred_labels,classificationReportFileName)
