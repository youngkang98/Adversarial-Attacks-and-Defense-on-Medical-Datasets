...
save_results_to_file(str(config.get_experiment_path('evaluation_result_after_adv_train_2.txt')),val_loss_no_noise,val_acc_no_noise, 0, 0, 0,targeted=False)
classificationReportFileName = str(config.get_experiment_path('classification_report_clean_after_advtrain_2.txt'))
generate_classification_report(true_labels,pred_labels,classificationReportFileName)
...
for current_attack_eps in attack_eps:
    for current_eps in eps:
        for image_count in image_counts:
            ...
            results_filename =fstr(config.get_experiment_path('evaluation_results_{image_count}_att{current_attack_eps}_eps{current_eps}.txt'))
            ...
            classificationReportFileName = fstr(config.get_experiment_path('classification_report_{image_count}_att{current_attack_eps}_eps{current_eps}.txt'))
            generate_classification_report(true_labels,pred_labels,classificationReportFileName)
