...
datapath = str(config.get_data_path('isic2018'))
testfile = str(config.get_data_path('df_test.csv'))
...
adversarialFile = str(config.get_data_path('df_train.csv'))
...
####### ISIC 2018 ###############
df_train=pd.read_csv(str(config.get_data_path('df_train.csv')))
df_train=df_train.drop(columns='Unnamed: 0')
df_test=pd.read_csv(str(config.get_data_path('df_test.csv')))
...
classificationReportFileName = str(config.get_experiment_path('classification_report_clean_before_advtrain.txt'))
