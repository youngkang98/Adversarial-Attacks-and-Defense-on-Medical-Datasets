...
train_path = str(config.get_data_path('OCT/train'))
...
val_path = str(config.get_data_path('OCT/val'))
# val_data = CustomImageDataset(val_path)
val_data = OCTDataset(val_path)

# Load test dataset
test_path = str(config.get_data_path('OCT/test'))
...
checkpoint = torch.load(str(config.get_model_path('OCT_morph.pth.tar')),map_location=torch.device('cpu'))
...
PATH = str(config.get_model_path('OCT.pth.tar'))
