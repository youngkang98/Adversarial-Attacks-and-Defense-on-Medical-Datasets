...
parser.add_argument('--trainfile', default=str(config.get_data_path('train_split_v3.txt')),
                    type=str, help='Path to testfile')
parser.add_argument('--testfile', default=str(config.get_data_path('test_split_v3.txt')),
                    type=str, help='Path to testfile')
