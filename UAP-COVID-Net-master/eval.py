...
if __name__ == '__main__':
    ...
    parser.add_argument('--weightspath', default='../../COVIDNet-CXR-3', type=str, 
    ...
    parser.add_argument('--n_classes', default=3, type=int, help='Number of detected classes, defaults to 2')
    parser.add_argument('--testfile', default='test_COVIDx8A.txt', type=str, help='Name of testfile')
    parser.add_argument('--testfolder', default='../../COVID-Net/test', type=str, help='Folder where test data is located')
    ...
    parser.add_argument('--is_medusa_backbone', default = True,action='store_true', 
